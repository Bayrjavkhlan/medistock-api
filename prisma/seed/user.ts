...
export async function seedUser(prisma: PrismaClient) {
  ...
  const usersData: Prisma.UserCreateInput[] = [
    ...
    },
    {
      ...
      name: "Улаанбаатар эмнэлэг А эзэн",
      phone: "00000011",
      emailVerified: true,
    },
    {
      ...
      password: hashSync("H123", 10),
      name: "Улаанбаатар эмнэлэг А менежер",
      phone: "00000002",
      emailVerified: true,
    },
    {
      ...
      name: "Улаанбаатар эмнэлэг А ажилтан",
      phone: "00000003",
      emailVerified: true,
    },
    {
      ...
      password: hashSync("H123", 10),
      name: "Улаанбаатар эмнэлэг Б эзэн",
      phone: "00000021",
      emailVerified: true,
    },
    {
      ...
      password: hashSync("H123", 10),
      name: "Улаанбаатар эмнэлэг Б менежер",
      phone: "00000022",
      emailVerified: true,
    },
    {
      ...
      password: hashSync("S123", 10),
      name: "Улаанбаатар эмнэлэг Б ажилтан",
      phone: "00000004",
      emailVerified: true,
    },
    {
      ...
      name: "Улаанбаатар эмийн сан А эзэн",
      phone: "00000031",
      emailVerified: true,
    },
    {
      ...
      password: hashSync("P123", 10),
      name: "Улаанбаатар эмийн сан А менежер",
      phone: "00000032",
      emailVerified: true,
    },
    {
      ...
      password: hashSync("P123", 10),
      name: "Улаанбаатар эмийн сан А ажилтан",
      phone: "00000033",
      emailVerified: true,
    },
    {
      ...
      password: hashSync("P123", 10),
      name: "Улаанбаатар эмийн сан Б эзэн",
      phone: "00000041",
      emailVerified: true,
    },
    {
      ...
      password: hashSync("P123", 10),
      name: "Улаанбаатар эмийн сан Б менежер",
      phone: "00000042",
      emailVerified: true,
    },
    {
      ...
      password: hashSync("P123", 10),
      name: "Улаанбаатар эмийн сан Б ажилтан",
      phone: "00000043",
      emailVerified: true,
    },
    {
      ...
      password: hashSync("P123", 10),
      name: "Улаанбаатар эмийн сан В эзэн",
      phone: "00000051",
      emailVerified: true,
    },
    {
      ...
      password: hashSync("P123", 10),
      name: "Улаанбаатар эмийн сан В менежер",
      phone: "00000052",
      emailVerified: true,
    },
    {
      ...
      password: hashSync("P123", 10),
      name: "Улаанбаатар эмийн сан В ажилтан",
      phone: "00000053",
      emailVerified: true,
    },
    {
      id: "user-14",
      email: "supplier1.owner@test.com",
      password: hashSync("SUP123", 10),
      name: "МедиЛаб Саплай Монголиа эзэмшигч",
      phone: "00000061",
      emailVerified: true,
    },
    {
      id: "user-15",
      email: "supplier1.manager@test.com",
      password: hashSync("SUP123", 10),
      name: "МедиЛаб Саплай Монголиа менежер",
      phone: "00000062",
      emailVerified: true,
    },
    {
      id: "user-16",
      email: "supplier1.staff@test.com",
      password: hashSync("SUP123", 10),
      name: "МедиЛаб Саплай Монголиа ажилтан",
      phone: "00000063",
      emailVerified: true,
    },
    {
      id: "user-17",
      email: "supplier2.owner@test.com",
      password: hashSync("SUP123", 10),
      name: "Сентрал Хоспитал Системс эзэмшигч",
      phone: "00000071",
      emailVerified: true,
    },
    {
      id: "user-18",
      email: "supplier2.manager@test.com",
      password: hashSync("SUP123", 10),
      name: "Сентрал Хоспитал Системс менежер",
      phone: "00000072",
      emailVerified: true,
    },
    {
      id: "user-19",
      email: "supplier2.staff@test.com",
      password: hashSync("SUP123", 10),
      name: "Сентрал Хоспитал Системс ажилтан",
      phone: "00000073",
      emailVerified: true,
    },
  ];
